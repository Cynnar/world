...
void MasterAAList::DisplayAA(Client* client) {
	...
	LogWrite(SPELL__DEBUG, 3, "AA", "ClassTab Size...%i ", num_class_items);
	...
	index = 0;
	LogWrite(SPELL__DEBUG, 3, "AA", "SubclassTab Size...%i ", num_subclass_items);
	...
	index = 0;
	LogWrite(SPELL__DEBUG, 3, "AA", "ShadowTab Size...%i ", num_shadow_items);
	...
	index = 0;
	LogWrite(SPELL__DEBUG, 3, "AA", "HeroicTab Size...%i ", num_heroic_items);
	...
	index = 0;
	LogWrite(SPELL__DEBUG, 3, "AA", "TradeskillTab Size...%i ", num_tradeskill_items);
	...
	index = 0;
	LogWrite(SPELL__DEBUG, 3, "AA", "PrestigeTab Size...%i ", num_prestige_items);
	...
	index = 0;
	LogWrite(SPELL__DEBUG, 3, "AA", "TradeskillPrestigeTab Size...%i ", num_tradeskillprestige_items);
